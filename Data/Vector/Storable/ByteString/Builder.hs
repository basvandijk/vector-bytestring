...
import           "Data.Vector.Storable.ByteString.Builder"
import           "Data.Vector.Storable.ByteString.Builder.ASCII" ('intDec')
import           Data.Monoid
...
See "Data.Vector.Storable.ByteString.Builder.Prim" for further
...
Apart from removing intermediate data-structures,
  ...
  parameters using the functions in "Data.Vector.Storable.ByteString.Builder.Extra" and
  their \"inner loops\" using the functions in
  "Data.Vector.Storable.ByteString.Builder.Prim".
-}


module Data.Vector.Storable.ByteString.Builder
    (
      -- * The Builder type
      Builder
      ...
      -- cases. See "Data.Vector.Storable.ByteString.Builder.Extra", for information
    ...
    -- "Data.Vector.Storable.ByteString.Builder.ASCII", we also provide efficient
    ...
    -- the functions from "Data.Vector.Storable.ByteString.Builder.ASCII", as the ASCII encoding
    ...
    -- functions from "Data.Vector.Storable.ByteString.Builder.ASCII" for UTF-8 encoding,
    -- as the ASCII encoding is equivalent to the UTF-8 encoding on the Unicode
    -- codepoints 0-127.
    , charUtf8
    , stringUtf8

    , module Data.Vector.Storable.ByteString.Builder.ASCII
...
import           Data.Vector.Storable.ByteString.Builder.ASCII (intDec)
import qualified Data.Vector.Storable.ByteString               as S (concat)
import           Data.Monoid
import           Data.Foldable                      (foldMap)
import           Data.List                          (intersperse)
...
{- Not yet stable enough.
   See note on 'hPut' in Data.Vector.Storable.ByteString.Builder.Internal
-}
