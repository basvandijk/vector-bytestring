...
"Data.Vector.Storable.ByteString.Builder". Its \"hot code\" is the rendering of a table's
cells, which we implement as follows using only the functions from the
'Builder' API.

@
import "Data.Vector.Storable.ByteString.Builder" as B
...
@
import qualified Data.Vector.Storable.ByteString.Builder.Prim  as P
import           Data.Vector.Storable.ByteString.Builder.Prim
...
-- the following.
--
-- > import Data.Vector.Storable.ByteString.Builder.Prim.Utf8 (char)
-- >
-- > {-# INLINE escapeChar #-}
...
-- functions in "Data.Vector.Storable.ByteString.Lazy" as
--
...
--
-- > import Data.Vector.Storable.ByteString.Builder.Extra     -- assume these
-- > import Data.Vector.Storable.ByteString.Builder.Prim      -- imports are present
...
in "Data.Vector.Storable.ByteString.Builder.Extra". There, we continue the above example
...
-}
module Data.Vector.Storable.ByteString.Builder.Prim (
  ...
  -- 'byteStringHex' from "Data.Vector.Storable.ByteString.Builder.ASCII", which is
  ...
  , module Data.Vector.Storable.ByteString.Builder.Prim.Binary

  -- ** Character encodings
  , module Data.Vector.Storable.ByteString.Builder.Prim.ASCII
...
import           Data.Vector.Storable.ByteString.Builder.Internal
import           Data.Vector.Storable.ByteString.Builder.Prim.Internal.UncheckedShifts
import           Data.Vector.Storable.ByteString.Builder.Prim.Internal.Base16 (lowerTable, encode4_as_8)

import qualified Data.Vector.Storable.ByteString               as S
import qualified Data.Vector.Storable.ByteString.Internal      as S
import qualified Data.Vector.Storable.ByteString.Lazy.Internal as L
...
import           Data.Vector.Storable.ByteString.Builder.Prim.Internal hiding (size, sizeBound)
import qualified Data.Vector.Storable.ByteString.Builder.Prim.Internal as I (size, sizeBound)
import           Data.Vector.Storable.ByteString.Builder.Prim.Binary
import           Data.Vector.Storable.ByteString.Builder.Prim.ASCII
...
--
-- > import Data.Vector.Storable.ByteString.Builder.Primas P (word8, condB, emptyB)
--
...
primMapByteStringBounded w =
  ...
  where
    ...
    step v !k =
      ...
      where
        (ifp, isize) = VS.unsafeToForeignPtr0 v
