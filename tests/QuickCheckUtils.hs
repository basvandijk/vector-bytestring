...
import qualified Data.Vector.Storable.ByteString.Lazy.Internal as L (checkInvariant,ByteString(..))

import qualified Data.Vector.Storable.ByteString.Char8      as PC
